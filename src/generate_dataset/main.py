...
if __name__ == '__main__':
    ...
    model = model.Elmo(elmo_folder + 'external/elmo_2x4096_512_2048cnn_2xhighway_options.json',
                       elmo_folder + 'external/elmo_2x4096_512_2048cnn_2xhighway_weights.hdf5',
                       args.cuda_device)
