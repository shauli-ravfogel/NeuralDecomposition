"""
references
https://github.com/allenai/allennlp/blob/master/allennlp/models/biaffine_dependency_parser.py
"""
...
@Model.register("biaffine_parser_syn")
class BiaffineDependencyParser(Model):
    ...
    def forward(self,  # type: ignore
        ...
        """
        # if self.use_raw_tokens:
        #     raw_tokens = [meta["words"] for meta in metadata]
        ...
        embedded_text_input = self._pos_tag_embedding(pos_tags)
