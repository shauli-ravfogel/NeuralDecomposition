...
if __name__ == '__main__':
    ...
    train = dataset.Dataset("sample.25k")
    dev = dataset.Dataset("sample.25k")

    training_generator = data.DataLoader(train, batch_size=1500, drop_last = True, shuffle=True)
    dev_generator = data.DataLoader(dev, batch_size=1500, shuffle=False, drop_last = True)
