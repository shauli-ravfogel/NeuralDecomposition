...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Split data to train, dev and test',
    ...
    train, eval_split = train_test_split(data, test_size=1 - args.train_size, random_state=42)
