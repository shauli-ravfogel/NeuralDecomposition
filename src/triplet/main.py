...
if __name__ == '__main__':
    ...
    optimizer = optim.Adam(network.parameters(), weight_decay = 5 * 1e-4) # 0 = no weight decay, 1 = full weight decay
    ...
    training_generator = data.DataLoader(train, batch_size=256, shuffle=True)
    dev_generator = data.DataLoader(dev, batch_size=256, shuffle=False)
