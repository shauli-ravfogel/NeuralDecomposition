...
"num_sentences": 20,
"pos_tags_to_replace":  ["NN", "NNS", "NNP", "NNPS", "PRP$", "JJ", "CD", "VB", "VBD", "VBG", "VBN", "VBP", "VBZ"],
"function_words": ["in", "on", "at", "the", "a", "an", "who", "that", "this", "which", "can", "cannot", "not", "no", "do", "does", "of", "these", "those", ",", ".", "'", "(", ")", "under", "above", "near", "without", "have", "has", "got", "as", "nor", "am", "is", "are", "although", "while", "between", "neither", "and", "or", "one", "among", "anything", "beside", "besides", "both", "off", "did", "nothing", "now", "over", "rather", "perhaps", "sometime", "such", "still", "upon", "up", "down", "whereas", "where", "why", "yes", "yet", "were", "was", "been", "be", "will", "would", "amongst", "always", "along", "all", "afterwards"]	 
}
